# Electron and React
## Introduction
ngl the setup kinda jank so I wanted to explain how stuff works so far

## set up
in the `frontend/` simply run 
```
npm install
```
...
# the automatically generated read me that was generated
